          ...
          <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
            ...
            <form>
              ...
              <div class="relative w-full mb-3">
                ...
                <input v-model="password" type="password" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Password" autocomplete="username" />
  ...
  methods: {
    async handleLogin() {
      try {
        ...
        this.errorMessage = 'Une erreur s\'est produite lors de la tentative de connexion. Veuillez réessayer.';
      }
    }
